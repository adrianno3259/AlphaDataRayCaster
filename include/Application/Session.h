...
namespace Application
{
    ...
    /** Struct that contains information on the current rendering session.
    *   It stores the scene objects as well as the output image and 
    *   configuration parameters
    *
    *   It is also responsible for reading the input configuration file
    */
    struct Session
    {
        bool useFPGA;
